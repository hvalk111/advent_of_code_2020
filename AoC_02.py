...
def get_bounds(input_str):
    return (int(input_str.split("-")[0]), int(input_str.split("-")[1][0:2]))

def get_char_count(input_str):
    output_count = 0
    for char in input_str.split(": ")[1]:
        if char == get_char(input_str):
            output_count += 1
    return output_count

def check_rule(input_str):
    if (get_char(input_str) == input_str.split(": ")[1][get_bounds(input_str)[0]-1]) or (get_char(input_str) == input_str.split(": ")[1][get_bounds(input_str)[1]-1]):
        if (get_char(input_str) == input_str.split(": ")[1][get_bounds(input_str)[0]-1]) != (get_char(input_str) == input_str.split(": ")[1][get_bounds(input_str)[1]-1]):
            return True
        else:
            return False
    else:
...
if __name__ == "__main__":
    ...
    #single_line = 4
    #print(input_list[single_line])
    #print(get_char(input_list[single_line]))
    #print(get_bounds(input_list[single_line]))
    #print(get_char_count(input_list[single_line]))
    #print(check_rule(input_list[single_line]))

    valid_list = []
    for string in input_list:
        valid_list.append(check_rule(string))
