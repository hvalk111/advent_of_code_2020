...
rows = np.linspace(0,127,128)
columns = np.linspace(0,7,8)
...
for code in input_list:
    ...
    if code[2] == 'F':
        ...
        column_list.append(columns[1])

id_list = [row_list[i]*8+column_list[i] for i in range(len(row_list))]
